...
import { average } from "./file1"; //it imports the work done in arrow function name "average" in file1.ts

console.log(average(3, 4, 5)); //Output : 4 //here we are calling function and giving argument
