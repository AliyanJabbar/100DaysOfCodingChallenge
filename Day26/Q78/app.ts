...
function cubingDeclaration(num1: number): number {
  return num1 * num1 * num1;
}
console.log(cubingDeclaration(2));

// 2. function expression
let cubingExpression = function cubingExpression(num2: number): number {
  //here the name of function after "= function " can be neglect
