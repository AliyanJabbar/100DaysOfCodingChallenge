...
function parameters(num1: number, num2: number): number {
  //here I am giving parameters
  return num1 + num2;
}
console.log(parameters(2, 5)); //here I am calling the function , giving arguments and printing it
