...
let person = {
 ...
 export let jsonString = JSON.stringify(person); // Converts the object into a JSON string and assigining it to a variable named "jsonString"

console.log(jsonString); // Output : {"name":"Ali","age":18,"ID":1324}
